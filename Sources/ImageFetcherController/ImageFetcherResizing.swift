...
extension UIImage {
    public func resizeTo(targetSize:CGSize) -> UIImage? {
        ...
        if let data = jpegData(compressionQuality: 0.6) {
            return decompressAndResize(imageData: data, sourceSize: sourceSize, targetSize: targetSize)
        }
        return nil
    }
}

public func decompressAndResize(imageData:Data, sourceSize:CGSize, targetSize:CGSize) -> UIImage? {
